...
eli mallille annetaan syötearvoja (input) ja malli antaa näiden perusteella
tulosarvot (output) mitä mallin mukaan tulee tapahtumaan.
...
\textbf{TODO: Ehkä ei tätä osiota 
tai sulautetaan seuraavaan teksikappaleeseen}
1940-luvun puolivälissä simulaatiot saivat kaksi suurta kehitysaskelta, ensimmäisten tietokoneiden rakentaminen ja Monte Carlo-metodin ensimmäiset toteutukset tietokoneen avulla 
%
\parencites%
    {HistoryOfSimulation}%
    {historyOfSimulation1996}
...
Monte Carlo simulaatio perustuu todennäköisyyden laskemiseen, 
jossa todennäköisyyttä aproksimoidaan laskemalla ... \textbf{TODO: avaa Monte Carlo metodia}.
...
\relax.
%
Laadullinen päättely viittaa tieteellisiin tapoihin joilla voidaan tutkia kohdetta, jonka toiminnan tiedosta on puutteita tai aukkoja. \textbf{TODO: avaa menetelmiä/esimerkkejä laadullisesta päättelystä.}
...
Ensimmäistä sivukysymystä varten tieteenalat kerättiin aluksi pelkästään ScienceDirectin omista määritelmistä. ScienceDirectin omat määritelmät todettiin sellaisenaan liian ylätasoisiksi, joten tarkempi tieteenala kerättiin artikkeleista käyttäen apuna SciSpace -tekoälyohjelmaa \footnote{\url{https://typeset.io/} käytetty viimeksi 22.1.2025.}. 
...
laisinkaan artikkeli merkittiin osioon, joka oli tarkempaa tieteenalaan verrattuna sopivin.
Tapauksissa, joissa ScienceDirectilla oli useampi tieteenala valittiin näistä osuvin 
verraten artikkelin julkaisukohteesta ja tarkemmasta tieteenalasta.
...
\subsection{Tavoitteet tieteenaloittain}

\subsection{Tavoitteet ja menetelmät}
