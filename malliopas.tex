...
\end{itemize}
Laadullinen päättely on hyödyllistä esimerkiksi jos 
...
\textbf{TODO: Kuinka tarkka kuvaus on tarpeen laadullisista simulaatioista?}
...
Laadullisella simulaatiolla voidaan varmistaa, että järjestelmän
...
mitätöidäkseen toistensa heikkouksia \parencite{semiHybrid1997qualitative}.

\subsection{Hyödyt}
\begin{comment}
    Mietin, onko vähän liian suoraviivaista aloittaa hyödyistä kun määritelmä ja tavoitteet jäävät aika auki. 
    
    Tarvitaanko vahvemmin määrittelevä ja ominaisuuksia kuvaava alaluku. 
...
\textbf{Tutkittavan järjestelmän toiminnan selkentäminen} & xx \\ 
\hline
3.Pyritään vähentämään tutkimuskohteen tiedon aukkoja.  &  55  \\ 
\hline
5.Halutaan selvittää miten olosuhteiden vaihtuminen vaikuttaa simulaation kohteeseen.  &  20  \\ 
\hline
9. Halutaan ennustaa kohteen käyttäytymistä/toimintaa. & 10 \\ 
\hline
\textbf{Tutkittavan järjestelmän vian tai epätoivotun toiminnan selvittäminen} & 32 \\
\hline
1.Pyritään selvittämään miten toteutunut ongelma/haitta vaikuttaa kohteeseen tai tilanteeseen. & 5 \\ 
\hline
2.Pyritään selvittämään vian syitä/mahdollisuuksia. & 27 \\ 
\hline
\textbf{Menetelmien tutkiminen (uusi menetelmä ja/tai menetelmien vertailu)} & xx \\
\hline
4.Simulaatiolla pyritään vertaamaan tuloksia toiseen tutkimukseen tai samassa tutkimuksessa tehtyihin kokeisiin. & 44 \\ 
\hline
6.Halutaan optimoida jotain metodeja/tapoja liittyen tutkittavaan kohteeseen/työkaluun. & 36 \\ 
\hline
7.Tutkimuksessa luotiin kokonaan uusi työkalu/metodi laadullisten simulaatioiden luontiin/käyttämiseen. & 38 \\ 
\hline
8.Verrataan erilaisten laadullisten simulaatioiden/algoritmien toimintaa.           &  5 \\ 
\hline
\end{tabular}%
}
