...
Taulukoista \ref{table:ohjelmistot 1.}, \ref{table:ohjelmistot 2.} ja 
...
\ref{table:mallintaminen 2.}, \ref{table:mallintaminen 3.},
\ref{table:ohjelmistot 1.}, \ref{table:ohjelmistot 2.} ja 
\ref{table:ohjelmistot 3.}. Näistä useimmin esiintyneet mallintamisen työkalut
