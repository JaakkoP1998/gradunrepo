...
\translatedtitle{Systematic literature mapping of qualitative simulation usage in scientific research}
...
\textit{Laadullinen päättely (eng. qualitative reasoning)} \textbf{TODO: en tiedä} viittaa tieteellisiin tapoihin joilla voidaan tutkia kohdetta, jonka toiminnan tiedosta on puutteita tai aukkoja. Laadullinen simulointi on yksi laadullisen päättelyn menetelmistä \parencite{kuipers1986qualitative}. \textbf{TODO: avaa menetelmiä/esimerkkejä laadullisesta päättelystä.}
...
sopiviksi 244 artikkelia. Näistä tarkemmin katsottuna karsittiin pois 58 artikkelia, 
eli aineistoon jäi lopuksi 186 artikkelia. Syitä artikkelien pois jäämiseksi oli, 
...
ScienceDirectin luokitusta ei voinut käyttää sellaisenaan, koska kaikilla artikkeleilla ei 
ollut luokitusta laisinkaan tai oli useampi luokitus. Tapauksissa, joissa luokitusta ei ollut
laisinkaan artikkeli merkittiin osioon, joka oli tekoälyn antamaan tarkempaan 
tieteenalaan verrattuna sopivin. Tapauksissa, joissa ScienceDirectilla oli useampi tieteenala valittiin näistä osuvin  verraten artikkelin julkaisukohteesta ja tarkemmasta tieteenalasta.
...
\begin{enumerate}
    \item Työkalulla on nimi, joka voidaan helpoisti merkitä talteen (esimerkiksi
    tutkjoiden itse tekemät ohjelmat eivät kelvanneet, jos niitä ei nimetty)
    \item Työkalu liittyi jotenkin laadullisten simulaatioiden luomiseen.
\end{enumerate}
...
\textbf{TODO: Ehkä vähän parempi nimitys 1. ja 2. kategorioille.}
...
\begin{table}[]
    ...
    \hline
    \end{tabular}
    \caption{Kategorian 3 tieteenalat, osa 1}
    \label{table:Kategorian 3.1 tieteenalat}
\end{table}
...
\begin{table}[]
    ...
    \end{itemize}& 15 \\
     ...
     \end{itemize} & 1 \\
     \hline
     \textbf{TODO: Miten saadaan taulukko mahtumaan.}   &   & \textbf{55} \\
    \hline
    \end{tabular}
    \caption{table:Kategorian 3 tieteenalat, osa 2}
    \label{table:Kategorian 3.2 tieteenalat}
\end{table}
...
\begin{table}[]
    ...
    \textbf{1. Kategoria}    & \textbf{2. Kategoria} & \textbf{Yht.} \\
    \hline
    Agricultural and Biological Science    & xxx & 2 \\
    \hline
    Chemical Engineering & xxx & 2 \\
    \hline
    Chemistry & xxx & 3 \\
    \hline
    Computer Science & xxx & 3 \\
    \hline
    Earth and Planetary Science & xxx & 2 \\
    \hline
    Economics, Econometrics and Finance & xxx & 2 \\
    \hline
    Energy & xxx & 3 \\
    \hline 
    Engineering & xxx & 4 \\
    \hline
    Environmental Science & xxx & 3 \\
    \hline
    Materials Science & xxx & 15 \\
    \hline
    Neuroscience & xxx & 1 \\
    \hline
    Physics and Astronomy & xxx & 2 \\
    \hline
    Social Science & xxx & 2 \\
    \hline
    \textbf{TODO: Miten saadaan taulukko mahtumaan.}   &   & \textbf{44} \\
    \hline
    \end{tabular}
...
\begin{table}[]
    ...
    \textbf{1. Kategoria}    & \textbf{2. Kategoria} & \textbf{Yht.} \\
    \hline
    Agricultural and Biological Science  & placeholder & 1 \\
    \hline
    Chemical Engineering & xxx & 2 \\
    \hline
    Computer Science & xxx & 1 \\
    \hline
    Earth and Planetary Science & xxx & 1 \\
    \hline
    Economics, Econometrics and Finance & xxx & 1 \\
    \hline
    Engineering & xxx & 1 \\
    \hline
    Environmental Science & xxx & 9 \\
    \hline
    Materials Science & xxx & 3 \\
    \hline
    Physics and Astronomy & xxx & 1 \\
    \hline
       &   & \textbf{20} \\
    \hline
    \end{tabular}
...
\begin{table}[]
    ...
    \textbf{1. Kategoria}    & \textbf{2. Kategoria} & \textbf{Yht.} \\
    \hline
    Agricultural and Biological Science  & xxx & 9 \\
    \hline
    Chemical Engineering & xxx & 4 \\
    \hline
    Computer Science & xxx & 5 \\
    \hline
    Earth and Planetary Science & xxx & 2 \\
    \hline
    Engineering & xxx & 9 \\
    \hline
    Environmental Science & xxx & 4 \\
    \hline
    Materials Science & xxx & 2 \\
    \hline
    Physics and Astronomy & xxx & 1 \\
    \hline
       &   & \textbf{36} \\
...
\begin{table}[]
    ...
    \textbf{1. Kategoria}    & \textbf{2. Kategoria} & \textbf{Yht.} \\
    \hline
    Agricultural and Biological Science  & xxx & 6 \\
    \hline
    Chemical Engineering & xxx & 10 \\
    \hline
    Computer Science & xxx & 5 \\
    \hline
    Decision Science & xxx & 1 \\
    \hline
    Earth and Planetary Science & xxx & 1 \\
    \hline
    Engineering & xxx & 10 \\
...
\begin{table}[]
    ...
    \textbf{1. Kategoria}    & \textbf{2. Kategoria} & \textbf{Yht.} \\
    \hline
    Agricultural and Biological Science  & xxx & 1 \\
    \hline
    ...
    Environmental Science & xxx & 3 \\
    \hline
    Materials Science & xxx & 1 \\
    \hline
    Mathematics & xxx & 1 \\
    \hline
    Medicine and Dentistry & xxx & 2 \\
    \hline
       &   & \textbf{10} \\
    \hline
    \end{tabular}
