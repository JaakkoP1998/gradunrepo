...
\textbf{TODO: simulaatio kolmanneksi laskennalliseksi tieteeksi?}
Yksi tunnettu menetelmä empiirisille tutkimuksille on simulointi.
...
tässä tutkimuksessä keskitytään tietokoneella ajattaviin simulaatiohjelmiin.

\textbf{TODO: Avataan laadullisia malleja ja niiden käyttötarkoituksia.}
...
Ensimmäisestä 677 artikkelista seulottiin tarkempaan tarkasteluun 
...
viittasivat vain toisen tekemään simulaatioon tai
...
\textbf{TODO: Mistä tuo tieteenala tuli (mikä luokitus ja mikä oli sen peruste, Science Directin oma vai jokin muu). Luokiteltiin alunperin ScienceDirectin mukaan, mutta osissa ei ollut mitään luokitusta. Luokitus joudutaan varmaan katsomaan uudelleen.}
Ensimmäistä sivukysymystä varten jokaiseen artikkeliin merkittiin tagilla tieteenala, mitä artikkelin tutkimus koski. Mendeley-ohjelmalla pystyttiin tagien kautta katsomaan kuinka monta artikkelia oli per ala, jotka merkittiin taulukkoon. Toista sivukysymystä varten artikkeleista haettiin viittauksia ohjeisiin ja työkaluihin. Löydetyt ohjeet ja työkalut merkittiin artikkeleiden tageihin, jotka koostettiin taulukkoihin.
