...
Yksi varhaisimmista simulaatiomenetelmistä on \textit{Monte Carlo simulaatio} 
\parencites%
    {historyOfSimulation1996}%
    {historyOfMonte}
\relax
%
, 
joka sai nimensä vuonna 1947 \parencite{historyOfMonte}.
...
\begin{comment}
    Jäsentäisikö tilannetta jaottelu, 
    jossa Monte Carlo viittaisi periaatteessa yksinkertaisiin syöte tulos malleihin, 
    jossa mallin logiikkaan ei tarvita aikaa ja ajasta/historiasta riippuvaa tilaa. 
    
    Sitten ovat erikseen aikaa käsittelevät mallit, jotka jakautuvat diskreettiaikaisiin ja jatkuva-aikaisiin.
\end{comment}
...
\begin{comment}
    Tässä on kyse koko työn avainkäsitteestä, joten tää on syytä tehdä huolella. 
    
    Nyt ei ole vielä mitään kovin selkeää määritelmää vaan muutama maininta, mitä voi tai voisi olla. 
    
    Löytyisikö jostakin listaa millaisiin kysymyksiin laadullisella simuloinnilla voi vastata tai millaisia piirteitä kohteen ominaisuuksista voidaan tavoitella. 
    
    Laadulliset näkökohdat ovat vielä aika ylätason kuvaus. Onko lähteissä kuvattu niitä paremmin?
\end{comment}
