...
\begin{tikzpicture}[scale=0.8]
  ...
  % row labels
  \foreach \a [count=\i] in {Agricultural,Chemical Sciences,Computer Sciences,Energy,Engineering,Environmental,Lifescience,Materials Science,Physics and Astronomy,Social and Psychology} {
...
Mallintamisessa käytetyt metodit ja algoritmit on jaettu kolmeen tavoitekategoriaan tieteenaloittain. Taulukossa ensimmäinen pylväs merkitsee
...
- Käytetystä aineistosta löydettiin yhdeksän eri tavoitetta, mitä laadullisella simulaatiolla
pyrittiin saavuttamaan tutkimuksessa.

- Eniten laadullisilla simulaatioilla pyrittiin vähentämään tutkittavan kohteen tietoisuuden
aukkoja.

- Laadullisien simulaatioiden luomiselle ollaan myös kehitetty ja parhaillaan 
kehittämässä paljon eri työkaluja ja metodeja.

- Vertailuja eri työkalujen tehokkuuksien välillä oli aika vähän tehty. Yksi teoria tälle voi 
olla että laadullisen simulaation tutkimuskohteet ovat liian niukkoja, jotta työkaluja joita
voitaisiin vertailla löytyisi.

- Myös toteutuneen vian vaikutuksia tutkittiin aika vähän. Teoria tälle on, että muissa tutkimuksissa, jotka liittyivät vikoihin, oltiin kiinnostuneempia vian ennaltaehkäisemisestä.
...
- Kemiantieteissä ja tekniikassa (engineering) yleisesti 
...
että puhutaan usein laadullisesta fysiikasta (Qualitative Physics), jolloinka tutkimuksia voi helposti jäädä aineiston ulkopuolelle, ,un haussa käytetty termi oli "qualitative simulation".
...
Yksi syy tavoitekategorian 2.1. vähäiselle esiintymiselle voi olla, 
...
- Mallintamisessa on myös käytetty useita eri abstraktointiin perustuvia sumeita tapoja.

- Ohjelmistoissa yleisiä ovat Matlab, GNA, Garp3, COMSOL ja OpenFOAM. Näistä Matlab esiintyi 
...
joka on kyvyiltään erittäin monipuolinen, mikä näkyy sen levinneisyydessä myös mitä tulee
laadullisille simulaatioille.
...
GNA on laadullisen mallintamisen ja simulaation työkalu.
