...
\tiivistelma{%
  Määrällinen simulaatio tarvitsee paljon numeerista taustatietoa järjestelmän toiminnasta, kun
  ...
  pinnallinen kuvaus laadullisten simulaatioiden käytöstä eri tieteenaloilla.
  ...
  laadullisten simulaatioiden luomiseen. Suurimpina havaintona todettiin, että laadullisilla
  ...
  aloilla. Yleisimpiä työkaluja simulaatioiden toteutukseen 
