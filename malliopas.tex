...
Löydetyt tieteen alat ja artikkelien lukumäärät aloittan on esitetty \textbf{TODO: taulukot vai listat}.
Tieteenalat on jaettu päätutkimuskysymyksen tuloksien kategorioiden mukaan.

\begin{itemize}
    \item Social Science, 5 
    \begin{itemize}
        \item Behavioral Science and Social Science, 2
        \item Transportation Engineering and Safety Science
        \item Behavioral Science and Psychology
        \item Behavioral Science and Safety Science
    \end{itemize}
\end{itemize}
