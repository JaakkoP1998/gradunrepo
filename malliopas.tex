...
a scientific method and how qualitative simulations were used in these studies. 
...
\begin{comment}
Tässä on selkeästi laadulliseen simulointiin tehtyjä (QSIM, GARP-perhe), 

selkeästi jatkuva-aikaisten ilmiöiden määrällisen simuloinnin työkaluja (COMSOL, OpenFOAM, Matlab, muut elementtimentelmä ja vastaavat), 

verkkoteoreettiset mallit (x graph). 

Sitten on selkeästi sovellusaluekohtaisia (geenit). 

Näistä varisnkin laadullisen simuloinnin yleisohjelmistot (QSIM, GARP ja ehkä sumea logiikka) olisi hyvä avata niin, että lukijalle jää käsitys siitä, mihin ne perustuvat ja millaisilla harteilla niitä pidetään yllä.
\end{comment}
