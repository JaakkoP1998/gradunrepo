...
\tiivistelma{%
Määrällinen simulaatio edellyttää huomattavaa määrää numeerista 
taustatietoa järjestelmän toiminnasta, 
kun taas laadullinen simulaatio mahdollistaa simuloinnin myös silloin, 
kun järjestelmän toiminnan tarkasta tiedosta on puutteita. 
Tässä tutkimuksessa toteutettiin systemaattinen kirjallisuuskartoitus laadullisten
simulaatioiden käytöstä tieteellisenä menetelmänä sekä tarkasteltiin,
miten laadullisia simulaatioita pyrittiin hyödyntämään kerätyn aineiston tutkimuksissa. Kirjallisuuskartoituksen tuloksena tuotettiin 
...
9 erilaista laadullisilla simulaatioilla haettua tavoitetta. 
...
simulaatioilla pyritään usein vähentämään kohdejärjestelmän tietoisuuden aukkoja. Eniten simulaatioita on käytetty kemian tieteiden, tekniikan ja materiaalitieteiden 
aloilla. Yleisimpiä työkaluja simulaatioiden toteutuksessa
ovat QSIM algoritmi ja Matlab-sovellus. 
}
\abstract{%
Quantitative simulation requires a considerable amount of numerical 
background information on the behavior of the system, 
whereas qualitative simulation allows simulation to be performed even then, 
when there is a lack of accurate information about the system's operations. 
This study conducted a systematic literature mapping study
on the use of qualitative simulations as
a scientific method and examined, 
how qualitative simulations were used in studies of the data collected. 
The systematic literature mapping study resulted in 
a broad description of the use of
...
Näiden korjaamiseksi käytettiin tekoälyn antamia tarkempia tieteenaloja.
...
\textbf{1. Tutkittavan järjestelmän toiminnan selventäminen} & \textbf{85} \\ 
\hline
...
Myös diskreetin elementin simulaatioita oli tunnistettu aineiston artikkeleista.
LIGGGHTS on diskreetin elementin simulaatio partikkeleille ja materiaaleille. 
Ns-2 on diskreetin elementtiin pohjautuva tietoverkkojen simulaattori.
SABER on yleiskäyttöinen simulaatio-ohjelmisto, 
jota käytettiin aineistossa laadullisen diskreetin elementin simulaation toteutuksessa.
...
uusien luomisesta. 
Jotta tälle saataisiin tarkempaa syytä, olisi tarpeen tehdä suhteutus
yleiseen julkaisumäärien kehitykseen. RELX-reportin mukaan Elsevier, 
julkisti vuonna 2022 600 000 artikkelia tutkimustietokannassaan
\footnote{\url{https://www.relx.com/investors/annual-reports/2022}, käyty 1.5.2025}. 
Pelkästään tästä luvustä nähdään, että kerätty aineisto on erittäin pieni verrattuna
kokonaisjulkaisumäärän kokoon, mikä tekee vahvojen johtopäätöksien tekemisestä hankalaa.
...
Tämä on huomattava määrä verrattuna aineistossa käytettyyn 184 artikkeliin, 
mikä voi ehdottaa, että aineiston ulkopuolelle on jäänyt sopivia artikkeleja fysiikan alalta.
...
Signeeratun graafin (eng. signed graph) menetelmiä 
...
Signeeratun graafin menetelmissä pyritään toteuttamaan syy-seuraus kaavioita, 
